...
export default function AIChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Сайн байна уу! Би таны fitness, дасгал, хооллолтын тухай асуултанд хариулах болно. Ямар асуулт байна вэ?',
    },
  ]);
              ...
              <div className="flex gap-3 justify-start">
                ...
                <div className="bg-white/5 rounded-2xl px-4 py-3">
                  <div className="flex gap-1">
                    ...
                    <div className="w-2 h-2 bg-[#D4FF00] rounded-full animate-bounce" style={{ animationDelay: '0.1s' }} />
                    <div className="w-2 h-2 bg-[#D4FF00] rounded-full animate-bounce" style={{ animationDelay: '0.2s' }} />
                  </div>
                </div>
              </div>
            )}
